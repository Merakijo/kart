...
describe 'Books API', type: :request do
	...
	let(:second_author) {FactoryBot.create(:author, first_name: 'Chandra', last_name: 'Churna', age: 78)}
	describe 'GET /books' do
		
		before do
			FactoryBot.create(:book, title: '1984', author: first_author)
			FactoryBot.create(:book, title: 'Time Machine', author: second_author)
		end
